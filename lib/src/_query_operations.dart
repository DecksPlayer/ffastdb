...
class _QueryOperations {
  ...
  Future<List<dynamic>> findImpl(List<int> Function(QueryBuilder q) queryFn) async {
    final builder = QueryBuilder(_db._secondaryIndexes);
